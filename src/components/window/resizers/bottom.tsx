...
import { BottomResizerBlock, ResizerProps } from "."

export function BottomResizer({ containerRef, updateWindowPosition }: ResizerProps) {
  ...
  return <BottomResizerBlock ref={ref} />
}
