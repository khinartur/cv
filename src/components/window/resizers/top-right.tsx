...
import { ResizerProps, TopRightResizerBlock } from "."

export function TopRightResizer({ containerRef, updateWindowPosition }: ResizerProps) {
  ...
  return <TopRightResizerBlock ref={ref} />
}
