...
import { LeftResizerBlock, ResizerProps } from "."

export function LeftResizer({ containerRef, updateWindowPosition }: ResizerProps) {
  ...
  const mousemoveHandler = useCallback(
    ...
    [containerRef.current, updateWindowPosition, containerWidth, containerY, mouseX],
  )
  ...
  return <LeftResizerBlock ref={ref} />
}
