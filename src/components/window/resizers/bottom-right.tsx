...
import { BottomRightResizerBlock, ResizerProps } from "."

export function BottomRightResizer({ containerRef, updateWindowPosition }: ResizerProps) {
  ...
  const mousemoveHandler = useCallback(
    ...
    [containerRef.current, updateWindowPosition, containerX, containerY],
  )
  ...
  return <BottomRightResizerBlock ref={ref} />
}
